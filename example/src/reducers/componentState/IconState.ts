...
const IconState: IDocument = {
  ...
  subheading: `Icon is used to visually communicate core parts of the product and available actions.It is used as different sources i.e.svg or placeholder with different colors.`,
  property: [
    {
      name: 'source',
