...
export { default as beAction } from './be-action.svg';
export { default as bottomPanelOff } from './bottom-panel-off.svg';
export { default as bottomPanelOn } from './bottom-panel-on.svg';
...
export { default as insertFile } from './insert-file.svg';
