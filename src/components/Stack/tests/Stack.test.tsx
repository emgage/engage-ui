...
describe('<Stack />', () => {
  ...
  describe('children property', () => {
    describe('when set', () => {
      ...
      it('should verify children property is defined', () => {
        ...
        expect(stackWrapper.childAt(0).childAt(0).prop('children').props.children).toBe('Paid');
        expect(stackWrapper.childAt(0).childAt(1).prop('children').props.children).toBe('Fulfilled');
      });
      it('should have 2 children', () => {
        ...
        expect(stackWrapper.childAt(0).children()).toHaveLength(2);
      });
    });
    ...
    describe('when not set', () => {
      ...
      it('should not have children property', () => {
        ...
        expect(stackWrapper.childAt(0).children()).toHaveLength(0);
      });
    });
  });
  ...
  describe('stack with item', () => {
    it('should verify stack where a single item fills the remaining space', () => {
      ...
      expect(stackWrapper.childAt(0).childAt(0).prop('fill')).toBe(true);
    });
  });
});
// TODO Debug Jest 
