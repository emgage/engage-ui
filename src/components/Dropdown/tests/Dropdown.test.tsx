...
describe('<Dropdown />', () => {
  ...
  describe('Default dropdown rendering', () => {
    it('Render Properly when direction is not provided', () => {
      ...
      expect(dropdownWrapper.find('div')).toHaveLength(7);
      ...
      expect(dropdownWrapper.find('div').at(2).hasClass('dropdownMenu')).toBeTruthy();
      expect(dropdownWrapper.find('div').at(3).hasClass('box')).toBeTruthy();
      ...
      expect(dropdownWrapper.find('div').at(5).hasClass('disabled')).toBeTruthy();
      expect(dropdownWrapper.find('div').at(6).hasClass('dropdownDivider')).toBeTruthy();
    });
