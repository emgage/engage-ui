...
export function getFilledLength(maskOptions: any, value: any) {
...
export function formatValue(maskOptions: any, value: any) {
...
export function clearRange(maskOptions: any, value: any, start: any, len: any) {
    const end = start + len;
    const { maskChar, mask, prefix } = maskOptions;
...
export function insertString(maskOptions: any, value: any, insertStr: any, insertPos: any) {
    ...
    arrayInsertStr.every((insertCharacter: any) => {
        ...
        const isAllowed = isAllowedChar(maskOptions, insertPos, insertCharacter)
            ||
...
export function getInsertStringLength(maskOptions: any, value: any, insertStr: any, insertPos: any) {
