  ...
  describe('when default props are provided', () => {
    it('basic message should have rendered 1 noscript element', () => {
      const messageWrapper = mount(
                                    <Message customId="10101" theme={theme} />
                               );
  ...
  describe('id property', () => {
    describe('when set', () => {
      ...
      it('should verify id when set', () => {
        ...
        expect(messageWrapper.prop('customId')).toBe('10101');
      });
    });
  });
  ...
  describe('isVisible property', () => {
    ...
    describe('when set to true', () => {
      it('basic message should have rendered 1 div element', () => {
        const messageWrapper = mount(
                                      <Message customId="10101" isVisible={true} theme={theme} >
                                          Click Here
                                      </Message>
                               );
    ...
    describe('when set to false', () => {
      it('basic message should have rendered 1 noscript element', () => {
        const messageWrapper = mount(
                                      <Message customId = "10101" isVisible={false} theme={theme}>
                                        Click Here
                                      </Message>
                               );
        expect(messageWrapper.find('noscript')).toHaveLength(1);
