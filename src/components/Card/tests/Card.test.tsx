...
describe('Card - Test Suit', () => {
    ...
    Header: 'Header',
    Section: 'Section',
    // Section-subdued:'Section-subdued',
    SectionHeader: 'SectionHeader',
    Footer: 'Footer',
    }

    it('Verify that Card has <h2> tag.',()=>{
        const cardWrapper = mount( <Card    title="Online store dashboard - Card"
                                            sectioned
                                            subdued
                                    >
                                    <p>View a summary of your online store’s performance.</p>
                                    </Card>); 
        //console.log(cardWrapper.html());
    ...
    it('Verify actions is called',()=>{
        const spy = jest.fn();
        let action: Action = {content:'Action Content', onAction:function(){
            spy();
            console.log('called');}};
    ...
    it('Verify that Card can have multiple sections with title.',()=>{
        const cardWrapper = mount( <Card    title="Online store dashboard - Card"
                                ...
                                <Card.Section title="Summary Reports">
    ...
    it('Verify Card with subdued option.',()=>{
        const cardWrapper = mount( <Card    title="Online store dashboard - Card"
                                    ...
                                    >
                                        ...
                                        <Card.Section title="Summary Reports" subdued>
                                            <p>View a summary of your online store’s performance, including sales, visitors, top products, and referrals.</p>
                                        </Card.Section>
                                    </Card>); 
        expect(cardWrapper.find('h3').length).toBe(2);        
        expect(cardWrapper.find('p').length).toBe(2);       
        //console.log(cardWrapper.childAt(1).html() as any);
    ...
    it('Verify Card with theme.',()=>{
        const cardWrapper = mount( <Card    title="Online store dashboard - Card"
                                            ...
                                            theme={theme}
                                    >
                                        <Card.Section title="Reports" subdued theme={theme}> 
                                            <p>View a summary of your online store’s performance.</p>
                                        </Card.Section>
                                        <Card.Section title="Summary Reports" subduedtheme={theme}>
                                            <p>View a summary of your online store’s performance, including sales, visitors, top products, and referrals.</p>
                                        </Card.Section>
                                        </Card>); 
