...
class SingleDatePickerInput extends React.Component<Props, State> {
  static defaultProps = {
...
export default themr(DATEPICKER, baseTheme)(SingleDatePickerInput) as ThemedComponentClass<Props, State>;
