...
const chooseAvailableStartDate = ({ date }: any) => `Choose ${date} as your check-in date. It's available.`;

// eslint-disable-next-line camelcase
const chooseAvailableEndDate = ({ date }: any) => `Choose ${date} as your check-out date. It's available.`;
const chooseAvailableDate = ({ date }:any) => date;
const dateIsUnavailable = ({ date }: any) => `Not available. ${date}`;
