...
describe('<Tooltip />', () => {
  ...
  describe('when default props are provided', () => {
    it('basic tooltip should have rendered one span element', () => {
      const tooltipWrapper = mount(
                                    <Tooltip content="This order has shipping labels." theme={theme} active={false} light={false} />
                             );
  ...
  describe('children property', () => {
    ...
    describe('when not set', () => {
      ...
      it('should verify children property is not defined', () => {
        const tooltipWrapper = mount(
                                      <Tooltip content="This order has shipping labels." active={false} light={false} />
                               );
  ...
  describe('active property', () => {
    describe('when set to true', () => {
      it('basic tooltip should have rendered 1 span element', () => {
        const tooltipWrapper = mount(
                                      <Tooltip content="This order has shipping labels." active theme={theme} light={false}>
                                          <Link external={false}>Order #1001</Link>
                                      </Tooltip>
                               );
        expect(tooltipWrapper.find('span')).toHaveLength(1);
    ...
    describe('when set to false', () => {
      it('basic tooltip should have rendered 1 span element', () => {
        const tooltipWrapper = mount(
                                      <Tooltip content="This order has shipping labels." active={false} theme={theme} light={false}>
                                          <Link external={false}>Order #1001</Link>
                                      </Tooltip>
                               );
        expect(tooltipWrapper.find('span')).toHaveLength(1);
  ...
  describe('light property', () => {
    describe('when set to true', () => {
      it('basic tooltip should have rendered 1 span element', () => {
        const tooltipWrapper = mount(
                                      <Tooltip content="This order has shipping labels." light theme={theme} active={false}>
                                          <Link external={false}>Order #1001</Link>
                                      </Tooltip>
                               );
        expect(tooltipWrapper.find('span')).toHaveLength(1);
    ...
    describe('when set to false', () => {
      it('basic tooltip should have rendered 1 span element', () => {
        const tooltipWrapper = mount(
                                      <Tooltip content="This order has shipping labels." light={false} theme={theme} active={false}>
                                          <Link external={false}>Order #1001</Link>
                                      </Tooltip>
                               );
        expect(tooltipWrapper.find('span')).toHaveLength(1);
  ...
  describe('preferredPosition property', () => {
    describe('when set', () => {
      it('basic tooltip should have rendered 1 span element', () => {
        const tooltipWrapper = mount(
                                      <Tooltip content="This order has shipping labels." preferredPosition="below" theme={theme} active={false} light={false}>
                                          <Link external={false}>Order #1001</Link>
                                      </Tooltip>
                               );
        expect(tooltipWrapper.find('span')).toHaveLength(1);
      ...
      it('should verify preferredPosition property when position as above', () => {
        const tooltipWrapper = mount(
                                      <Tooltip content="This order has shipping labels." preferredPosition="above" theme={theme} active={false} light={false}>
                                          <Link external={false}>Order #1001</Link>
                                      </Tooltip>
                               );
      ...
      it('should verify preferredPosition property when position as mostSpace', () => {
        const tooltipWrapper = mount(
                                      <Tooltip content="This order has shipping labels." preferredPosition="mostSpace" theme={theme} active={false} light={false}>
                                          <Link external={false}>Order #1001</Link>
                                      </Tooltip>
                               );
  ...
  describe('activatorWrapper property', () => {
    describe('when set', () => {
      it('basic tooltip should have rendered no span element', () => {
        const tooltipWrapper = mount(
                                      <Tooltip content="This order has shipping labels." activatorWrapper="Test" theme={theme} active={false} light={false}>
                                          <Link external={false}>Order #1001</Link>
                                      </Tooltip>
                               );
      ...
      it('should verify activatorWrapper property is available', () => {
        const tooltipWrapper = mount(<Tooltip content="This order has shipping labels." activatorWrapper="Test" theme={theme} active={false} light={false}>
                                        <Link external={false}>Order #1001</Link>
                                     </Tooltip>
                               );
